...
img = py.image.load('Icon.png')
py.display.set_icon(img)
py.display.set_caption('Navigateur')
map = py.image.load('carte.png')
map = py.transform.scale(map,(width,height))

green=py.image.load('check.png')
red=py.image.load('delete.png')
here=py.image.load('user.png') 

carte=py.image.load('carte_oversimplified.png')
carte=py.transform.scale(carte,(width,height))

Vp_V=py.transform.scale(py.image.load('Vp_Velo.png'),(width,height))
Vp_A=py.transform.scale(py.image.load('Vp_Aix.png'),(width,height))
Vp_L=py.transform.scale(py.image.load('Vp_Lumy.png'),(width,height))
Vp_C=py.transform.scale(py.image.load('Vp_Cal.png'),(width,height))
A_Vel=py.transform.scale(py.image.load('Aix_Velo.png'),(width,height))
A_lu=py.transform.scale(py.image.load('Aix_lumy.png'),(width,height))
A_cal=py.transform.scale(py.image.load('Aix_cal.png'),(width,height))
Vel_lu=py.transform.scale(py.image.load('Vel_lumy.png'),(width,height))
Vel_Cal=py.transform.scale(py.image.load('Velo_cal.png'),(width,height))
Lu_C=py.transform.scale(py.image.load('lumy_cal.png'),(width,height))
